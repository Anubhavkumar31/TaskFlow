...
// const STATUS_LABELS = { TODO: 'Todo', IN_PROGRESS: 'In Progress', PENDING_CONFIRMATION: 'Pending Confirmation', DONE: 'Done' }
// const STATUS_COLORS = {
...
// const MEMBER_STATUS_LABELS = { TODO: 'Todo', IN_PROGRESS: 'In Progress', PENDING_CONFIRMATION: '✓ Mark as complete' }
...
//                                 className="text-xs border border-gray-200 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white"
//                               >
//                                 {MEMBER_SELECTABLE_STATUSES.map(s => <option key={s} value={s}>{MEMBER_STATUS_LABELS[s]}</option>)}
//                               </select>
//                             ) : (
//                               <span className={`text-xs font-medium px-2 py-1 rounded-full ${STATUS_COLORS['PENDING_CONFIRMATION']}`}>⏳ Pending</span>
//                             )
//                           )
//                         ) : (
//                           <span className={`text-xs font-medium px-2 py-1 rounded-full ${STATUS_COLORS[task.status]}`}>{STATUS_LABELS[task.status]}</span>
//                         )}
//                       </td>
//                       <td className="px-4 py-3">
//                         {task.dueDate ? (
...
//                       {/* Pending confirmation label for member */}
//                       {task.status === 'PENDING_CONFIRMATION' && !isProjectAdmin && (
...
//                       {canChangeStatus ? (
//                         isProjectAdmin ? (
//                           // Admin sees all statuses including DONE + confirm/reject for pending
//                           task.status === 'PENDING_CONFIRMATION' ? (
//                             <div className="flex gap-2 mt-1">
//                               <button
//                                 onClick={() => handleStatusChange(task.id, 'DONE')}
//                                 className="flex-1 text-xs bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg px-2 py-1.5 transition-colors"
//                               >
//                                 ✓ Confirm done
//                               </button>
//                               <button
//                                 onClick={() => handleStatusChange(task.id, 'IN_PROGRESS')}
//                                 className="flex-1 text-xs bg-gray-100 hover:bg-gray-200 text-gray-600 font-medium rounded-lg px-2 py-1.5 transition-colors"
//                               >
//                                 ↩ Reject
//                               </button>
//                             </div>
...
//                           )
//                         ) : (
//                           // Member sees limited statuses, can't set DONE directly
//                           task.status !== 'PENDING_CONFIRMATION' ? (
//                             <select
//                               value={task.status}
//                               onChange={e => handleStatusChange(task.id, e.target.value)}
...
//                             </select>
//                           ) : (
//                             <div className="w-full text-xs bg-yellow-50 border border-yellow-200 rounded-lg px-2 py-1.5 text-center font-medium text-yellow-700">
//                               ⏳ Pending confirmation
//                             </div>
//                           )
//                         )
//                       ) : (
//                         <div className={`w-full text-xs rounded-lg px-2 py-1.5 text-center font-medium ${STATUS_COLORS[task.status]}`}>
